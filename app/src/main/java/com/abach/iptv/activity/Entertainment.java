...
public class Entertainment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressBar=findViewById(R.id.progressbarentertainment);
        MobileAds.initialize(this, new OnInitializationCompleteListener() {
            @Override
            public void onInitializationComplete(InitializationStatus initializationStatus) {
            }
        });
        mAdView = findViewById(R.id.adViewentertainment);
                ...
                .withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                    ...
                    public boolean onItemClick(@Nullable View view, int i, @NotNull IDrawerItem<?> iDrawerItem) {
                        if(iDrawerItem.getIdentifier()==1)
                        {
                            ...
                            AlertDialog.Builder alert = new AlertDialog.Builder(Entertainment.this);
                        ...
                        {
                            finish();
                            Intent intent = new Intent(Entertainment.this, News.class);
                            startActivity(intent);
                        }else if(iDrawerItem.getIdentifier()==2)
                        {
                            finish();
                            Intent intent = new Intent(Entertainment.this, Live.class);
                            startActivity(intent);
                        }else if(iDrawerItem.getIdentifier()==5)
                        {
                            finish();
                            Intent intent = new Intent(Entertainment.this, Kids.class);
                            startActivity(intent);
                        }
                        else if(iDrawerItem.getIdentifier()==6)
                        {
                            Intent intent = new Intent(Entertainment.this, sports.class);
                            startActivity(intent);
                        }
                        return false;
                    }
    ...
    {
        adapter= new CustomAdapter(Entertainment.this,channels);
        LinearLayoutManager layoutManager= new LinearLayoutManager(Entertainment.this);
