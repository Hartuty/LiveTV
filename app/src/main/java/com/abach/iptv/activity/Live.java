...
public class Live extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdView = findViewById(R.id.adViewlive);
                ...
                .withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                    ...
                    public boolean onItemClick(@Nullable View view, int i, @NotNull IDrawerItem<?> iDrawerItem) {
                        if(iDrawerItem.getIdentifier()==1)
                        {
                            ...
                            AlertDialog.Builder alert = new AlertDialog.Builder(Live.this);
                        ...
                        {
                            finish();
                            Intent intent = new Intent(Live.this, News.class);
                            startActivity(intent);
                        }else if(iDrawerItem.getIdentifier()==4)
                        {
                            finish();
                            Intent intent = new Intent(Live.this, Entertainment.class);
                            startActivity(intent);
                        }else if(iDrawerItem.getIdentifier()==5)
                        {
                            finish();
                            Intent intent = new Intent(Live.this, Kids.class);
                            startActivity(intent);
                        }else if(iDrawerItem.getIdentifier()==6)
                        {
                            Intent intent = new Intent(Live.this, sports.class);
                            startActivity(intent);
                        }
                        return false;
                    }
        ...
        call.enqueue(new Callback<List<Channels>>() {
            ...
            public void onResponse(Call<List<Channels>> call, Response<List<Channels>> response) {
                if(response.body().isEmpty())
                {
                    ...
                    alert.setMessage("We have no Streams at this time, Try again Later!!");
    ...
    {
        adapter= new CustomAdapter(Live.this,channels);
        LinearLayoutManager layoutManager= new LinearLayoutManager(Live.this);
