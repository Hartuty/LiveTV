...
public class sports extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdView = findViewById(R.id.adViewsports);
                ...
                .withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                    ...
                    public boolean onItemClick(@Nullable View view, int i, @NotNull IDrawerItem<?> iDrawerItem) {
                        if(iDrawerItem.getIdentifier()==1)
                        {
                            ...
                            AlertDialog.Builder alert = new AlertDialog.Builder(sports.this);
                        ...
                        {
                            finish();
                            Intent intent = new Intent(sports.this, Entertainment.class);
                            startActivity(intent);
                        }else if(iDrawerItem.getIdentifier()==2)
                        {
                            finish();
                            Intent intent = new Intent(sports.this, Live.class);
                            startActivity(intent);
                        }else if(iDrawerItem.getIdentifier()==5)
                        {
                            finish();
                            Intent intent = new Intent(sports.this, Kids.class);
                            startActivity(intent);
                        }
                        return false;
                    }
    ...
    {
        adapter= new CustomAdapter(sports.this,channels);
        LinearLayoutManager layoutManager= new LinearLayoutManager(sports.this);
