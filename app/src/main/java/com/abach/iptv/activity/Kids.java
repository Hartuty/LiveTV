...
public class Kids extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView=findViewById(R.id.recyclerviewkids);
        progressBar=findViewById(R.id.progressbarkids);
        MobileAds.initialize(this, new OnInitializationCompleteListener() {
            @Override
            public void onInitializationComplete(InitializationStatus initializationStatus) {
            }
        });
        mAdView = findViewById(R.id.adViewkids);
                ...
                .withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                    ...
                    public boolean onItemClick(@Nullable View view, int i, @NotNull IDrawerItem<?> iDrawerItem) {
                        if(iDrawerItem.getIdentifier()==1)
                        {
                            ...
                            AlertDialog.Builder alert = new AlertDialog.Builder(Kids.this);
                        ...
                        {
                            finish();
                            Intent intent = new Intent(Kids.this, News.class);
                            startActivity(intent);
                        }else if(iDrawerItem.getIdentifier()==4)
                        {
                            finish();
                            Intent intent = new Intent(Kids.this, Entertainment.class);
                            startActivity(intent);
                        }else if(iDrawerItem.getIdentifier()==2)
                        {
                            finish();
                            Intent intent = new Intent(Kids.this, Live.class);
                            startActivity(intent);
                        }else if(iDrawerItem.getIdentifier()==6)
                        {
                            Intent intent = new Intent(Kids.this, sports.class);
                            startActivity(intent);
                        }
                        return false;
                    }
    ...
    {
        adapter= new CustomAdapter(Kids.this,channels);
        LinearLayoutManager layoutManager= new LinearLayoutManager(Kids.this);
